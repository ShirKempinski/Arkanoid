...
public class GameLevel implements Animation {
    ...
    public GameLevel(LevelInformation info, KeyboardSensor keyboard, AnimationRunner runner,
        ...
        this.score = score;
        this.lives = lives;
        this.deathRegion = new Block(new Rectangle(new Point(0, 595), 800, 20), Color.LIGHT_GRAY, 0);
    ...
    public void initialize() {
        ...
        Block left = new Block(new Rectangle(new Point(0, 0), 20, 600), Color.GRAY, 0);
        Block right = new Block(new Rectangle(new Point(780, 0), 20, 600), Color.GRAY, 0);
        Block top = new Block(new Rectangle(new Point(0, 20), 800, 20), Color.GRAY, 0);
    ...
    public void playOneTurn() {
        Paddle paddle = new Paddle(this.keyboard, new Rectangle(new Point((800 - this.info.paddleWidth()) / 2, 570),
                this.info.paddleWidth(), this.info.paddleSpeed()), Color.ORANGE, this.info.paddleSpeed());
